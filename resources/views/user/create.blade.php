            ...
            <div class="card card-flush h-xl-100">
                ...
                <div class="card-header pt-5">
                    ...
                    <h3 class="card-title align-items-start flex-column">
                        ...
                        <span class="text-gray-400 mt-1 fw-semibold fs-6">Create a new user</span>
                    </h3>
                    <!--end::Title-->
                    <!--begin::Toolbar-->
                ...
                <div class="card-body pt-6">
                    <form method="post" action="{{ route("user.store") }}">
                        ...
                        <div class="mb-10">
                            ...
                            <textarea name="address" class="form-control form-control-solid" ></textarea>
                        ...
                        <div class="mb-10">
                            ...
                            <input name="birth" type="date" class="form-control form-control-solid" placeholder="..."/>
                            @if($errors->has('birth'))
                        ...
                        <div class="mb-10">
                            ...
                            <input name="phone" type="number" class="form-control form-control-solid" placeholder="..."/>
                            @if($errors->has('phone'))
