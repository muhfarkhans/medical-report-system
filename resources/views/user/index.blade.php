            ...
            <div class="card card-flush h-xl-100">
                ...
                <div class="card-header pt-5">
                    ...
                    <h3 class="card-title align-items-start flex-column">
                        ...
                        <span class="text-gray-400 mt-1 fw-semibold fs-6">List for all user registered</span>
                    </h3>
                    <!--end::Title-->
                    <!--begin::Toolbar-->
                    ...
                    <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                        ...
                        <button type="button" class="btn btn-light-primary" href="{{ route("user.create") }}">
                    ...
                    <table class="table align-middle border rounded table-row-dashed fs-6 gy-5 gs-7" id="kt_datatable_example">
                        ...
                        <tbody class="fw-semibold text-gray-600">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <a class="btn btn-sm btn-primary fw-bold px-4 me-1" id="" href="{{ route("user.edit", ["id" => $user->id]) }}">Edit</a>
                                        <a class="btn btn-sm btn-danger fw-bold px-4 me-1" id="" href="{{ route("user.delete", ["id" => $user->id]) }}">Delete</a>
                                    </div>
                                </td>
                            </tr>
                            @endforeach
