            ...
            <div class="card card-flush h-xl-100">
                ...
                <div class="card-header pt-5">
                    ...
                    <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                        ...
                        <button type="button" class="btn btn-light-primary" href="{{ route("report.create") }}">
                    ...
                    <table class="table align-middle border rounded table-row-dashed fs-6 gy-5 gs-7" id="kt_datatable_example">
                        <thead>
                            <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase">
                                ...
                                <th class="min-w-100px">Blood pressure</th>
                        ...
                        <tbody class="fw-semibold text-gray-600">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <a class="btn btn-sm btn-primary fw-bold px-4 me-1" id="" href="{{ route("report.edit", ["id" => $report->id]) }}">Edit</a>
                                        <a class="btn btn-sm btn-danger fw-bold px-4 me-1" id="" href="{{ route("report.delete", ["id" => $report->id]) }}">Delete</a>
                                    </div>
                                </td>
                            </tr>
                            @endforeach
